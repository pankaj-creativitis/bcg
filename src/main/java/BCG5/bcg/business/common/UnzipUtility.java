...
public class UnzipUtility {
	...
	// TODO: Need to devise a way to compile new client classes at compile time.
	// At-present, a second call is needed to make the entries in database.
	 ...
	 * @throws IOException
	 */
	private void extractFile(ZipInputStream zipIn, String filePath, String clientFilePath, String basePackage)
			throws IOException {
...
//	}
	...
	public void compile(String classDirectory) {
		...
		int result = cli.doMain(new String[] { "clean", "install" }, classDirectory, System.out, System.out);
	}
